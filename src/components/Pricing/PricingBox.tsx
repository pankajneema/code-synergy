const PricingBox = (props: {
  ...
  return (
    <div className="w-full">
      <div className="relative z-10 rounded-sm bg-white px-8 py-10 shadow-three hover:shadow-one dark:bg-gray-dark dark:shadow-two dark:hover:shadow-gray-dark" style={divStyle}>
        <div className="flex items-center justify-between">
          <h3 className="price mb-2 text-[25px] font-bold text-black dark:text-white">
