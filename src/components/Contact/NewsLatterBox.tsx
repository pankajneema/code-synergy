...
const NewsLatterBox = () => {
  ...
  const contactStyle = {
    ...
    padding: '50px 32px', // Default padding (py-11 and px-8)
  ...
  return (
    <div className="" style={contactStyle}>
      ...
      Be the first to know about our webinars, workshops, and other events. Receive the latest news and updates and access to special offers.
      </p>
      <div>
        <input
          type="text"
          ...
          style={boxstyle}
          className="border-stroke mb-4 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none focus:border-primary dark:border-transparent dark:bg-[#010428] dark:text-body-color-dark dark:shadow-two dark:focus:border-primary dark:focus:shadow-none"
        />
        <input
          type="email"
          name="email"
